...
<div
  id="explore_section"
  class="vertical-lg:min-h-[550-px] relative w-[100vw] min-w-full flex flex-row bg-navy sm:py-f80 sm:px-f64 lg:px-f128 lg:py-f96 vertical-lg:w-[100%]"
>
  <div id="explore_description" class="relative flex flex-row bg-navy text-teal vertical-lg:min-h-[550px] pr-f12">
    <div class="flex flex-col gap-f32">
        <span class="mt-f8 text-clip text-wrap font-title h1 font-normal"
          >Explore &amp; Build</span
        >

      <div
        class="sm text-white sm:max-w-[515px] sm:pb-[100px] lg:pb-[200px]"
      >
  ...
  <div class="lg:min-w-[716px] flex flex-row">
  <HAccordion
    sectionNumber="1"
