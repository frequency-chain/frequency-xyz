...
<SectionWrapper id="developers" classes="text-right flex lg:px-0 sm:pb-[140px] lg:pb-0">
  <section
  ...
  >
    ...
    <SectionParagraph classes="paragraph-spacing-right lg:pl-0 sm:pr-5">
      ...
      within the Frequency network that you love. This feature will also enable you to publicly alter your choices, and,
      if necessary, reevaluate your support of apps and services, encouraging ethical conduct and responsibility.
    </SectionParagraph>
  </section>
</SectionWrapper>
